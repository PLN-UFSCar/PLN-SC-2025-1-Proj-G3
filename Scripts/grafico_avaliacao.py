...
avaliador_1 = [4, 4, 3, 4, 5, 5]
avaliador_2 = [5, 5, 5, 5, 5, 5]
...
ax.set_title('Avaliação por Critérios e Avaliadores', fontsize=14, fontweight='bold')
ax.set_xticks(x)
...
print("Gráfico salvo como 'grafico_avaliacao.png'")
