...
# Dados de avaliação - Terceira tabela
criterios = ['Fluência', 'Adequação/Fidelidade', 'Clareza', 'Consistência', 'Estilo/Registro', 'Formatação']
avaliador_1 = [3, 3, 3, 3, 4, 5]
avaliador_2 = [3, 3, 2, 2, 4, 4]
avaliador_3 = [4, 3, 2, 2, 5, 4]
avaliador_4 = [4, 3, 3, 2, 5, 4]
...
ax.set_title('Avaliação por Critérios e Avaliadores - Terceira Avaliação', fontsize=14, fontweight='bold')
ax.set_xticks(x)
...
# Salvar o gráfico
plt.savefig('grafico_avaliacao_3.png', dpi=300, bbox_inches='tight')
print("Gráfico salvo como 'grafico_avaliacao_3.png'")
